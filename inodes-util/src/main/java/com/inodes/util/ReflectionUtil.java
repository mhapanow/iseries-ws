...
import com.inodes.exception.ReflectiveOperationException;


public class ReflectionUtil {

	public static boolean isMultipleValued (Class<?> clazz, String attributeName) {
		Field f = retrieveField(clazz, attributeName);
		if( null == f ) return false;
		return isMultipleValued(f.getType());
	}
	...
	public static <T> T instantiate (Class<T> clazz, Class<?>[] parameterTypes, Object[] parameters) {
		try {
